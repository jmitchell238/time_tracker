...
void main() {
  group('SectionContainer', () {
    ...
    testWidgets('title style is bold and AppColors.fg colored', (tester) async {
      await tester.pumpWidget(_wrap(SectionContainer(
        title: 'My Section',
        child: const Text('content'),
      )));
      ...
      expect(title.style!.color, AppColors.fg);
    });

    testWidgets('subtitle color is AppColors.fg2', (tester) async {
      await tester.pumpWidget(_wrap(SectionContainer(
        title: 'My Section',
        subtitle: 'hint',
        child: const Text('content'),
      ...
      expect(sub.style!.color, AppColors.fg2);
    });
